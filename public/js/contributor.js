...
async function fetchData() {
  try {
      const contributorsResponse = await fetch('https://api.github.com/repos/Soujanya2004/holidayz-2024/contributors?per_page=100');
const contributors = await contributorsResponse.json();

const repoResponse = await fetch('https://api.github.com/repos/Soujanya2004/holidayz-2024');
