...
document.addEventListener('DOMContentLoaded', function () {
  ...
  togglePassword.forEach((toggle) =>{
      toggle.addEventListener('click', function (e) {
          ...
          // Handle popup password toggle (unique ID)
          else if (e.target.id === 'togglePopupPassword') {
              password = document.querySelector('#popup-password');
          }
          // Handle regular password toggle
          else {
              password = document.querySelector('input[name="password"]:not(#popup-password)');
          }
...
if(submitFeedback){submitFeedback.addEventListener("click", () => {
  feedbackContainer.classList.remove("fade-out");
  feedbackForm.style.display = "flex";
});}

if(closeForm){closeForm.addEventListener("click", (event) => {
  event.preventDefault();
...
if(listingImageInput){listingImageInput.addEventListener('change', function() {
...
if(description){description.addEventListener("input", function() {
